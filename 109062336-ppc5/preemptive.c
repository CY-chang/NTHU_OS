...
__data __at (0x35) char tmp;
__data __at (0x36) char created_thread_ID; 
...
void Bootstrap(void) {
    ...
    SemaphoreCreate(unused_thread_count, 4);


    stack_pointers_for_threads[0] = 0;
    stack_pointers_for_threads[1] = 0;
    stack_pointers_for_threads[2] = 0;
    stack_pointers_for_threads[3] = 0;
...
ThreadID ThreadCreate(FunctionPtr fp) {
        ...
        EA = 0;
         ...
         if ((bitmap_for_threads & 1) == 0) created_thread_ID = 0;
         else if ((bitmap_for_threads & 2) == 0) created_thread_ID = 1; 
         else if ((bitmap_for_threads & 4) == 0) created_thread_ID = 2; 
         else if ((bitmap_for_threads & 8) == 0) created_thread_ID = 3; 
         

         idx_for_threads[created_thread_ID] = car_idx_counter;
         car_idx_counter += 1;
         if (car_idx_counter == 6) car_idx_counter = 1;
         // a.
         if (created_thread_ID == 0) bitmap_for_threads += 1;
         else if (created_thread_ID == 1) bitmap_for_threads += 2;
         else if (created_thread_ID == 2) bitmap_for_threads += 4;
         else if (created_thread_ID == 3) bitmap_for_threads += 8;
         //bitmap_for_threads |= 1 << created_thread_ID;

         // b, c
         tmp = SP; // save current SP
         SP = 0x40 + (created_thread_ID << 4) - 1;
